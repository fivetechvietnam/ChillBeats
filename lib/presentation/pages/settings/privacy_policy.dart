      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            _description(
                "This Privacy Policy governs the information practices of , an open-source mobile application only available on GitHub and F-Droid."),
            _heading("Personal Information:"),
            _description(
                " collects minimal personal information, such as a username and profile picture, solely for enhancing user experience. Users can browse anonymously if preferred."),
            _heading("Feedback:"),
            _description(
            ...
            _description(
                " is not available on mainstream app stores like the App Store or Google Play Store, ensuring user privacy and control."),
            _heading("Contact:"),
            _description(
